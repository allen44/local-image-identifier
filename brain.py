...
try:
    ...
    print(f"\n\nThe SqueezeNet model's top {result_count} predictions with probability: ")
    for eachPrediction, eachProbability in zip(predictions, probabilities):
        print(eachPrediction , " : " , eachProbability)
except:
    print("Squeezenet didn't work...") 
